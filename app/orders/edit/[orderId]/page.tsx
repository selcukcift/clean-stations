...
export default function EditOrderPage() {
  ...
  const focusBuild = searchParams.get('focusBuild')
  ...
  return (
    <div className="container mx-auto py-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              {focusBuild && ` • Editing build: ${focusBuild}`}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                ...
                {focusBuild && ` Focus on build configuration: ${focusBuild}`}
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
      ...
      <OrderWizard 
        ...
        focusBuildNumber={focusBuild || undefined}
      />
    </div>
  )
}