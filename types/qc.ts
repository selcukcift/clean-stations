...
export interface QcFormTemplateItem {
  ...
  relatedAssemblyId?: string | null;
  relatedPartNumber?: string | null;
  repeatPer?: string | null;
...
export interface FileUploadBasic {
  id: string;
  filename: string;
  originalName: string;
  mimeType: string;
...
export interface QcItemResultMediaAttachment {
  id: string;
...
export interface OrderQcItemResult {
  ...
  repetitionInstanceKey?: string | null;
  orderQcResult?: OrderQcResult;
  qcFormTemplateItem?: QcFormTemplateItem;
  attachedDocument?: FileUploadBasic;
  mediaAttachments?: QcItemResultMediaAttachment[];
}
